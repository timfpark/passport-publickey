 ...
 *
 * Applications must supply a `verify` callback which accepts `{{}}` and
 * `signature`. The server should lookup the principal with this findByValue,
 * and decrypt the challenge, and confirm that the encryptedAuth is of the form
 * "findByValue:timestamp" and that timestamp is within an application defined envelope.
 *
